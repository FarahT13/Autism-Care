...
<html>
<head>
	<title>Analyst Registration Page</title>
...
<body>
	...
	<form  class="myform" action="AnalystR.php" method="post">
	<label><b>Username: </b></label><br>
	<input name="User_name" type="text" class="inputvalues" placeholder="Type your username" required/><br>
	<label><b>password:</b></label><br>
	<input name="pass_word" type="password" class="inputvalues" placeholder="Your password" required/><br>
	<label><b>Confirm password: </b></label><br>
	<input  name="confirmpassword" type="password" class="inputvalues" placeholder="Confirm password" required/><br>
	<a href="analysP.php"><input name="submit_btn" type="submit" id="signup_btn" value="Sign Up"/></a><br>
	...
	if(isset($_POST['submit_btn']))
	{
		...
		{
			$query= "select *from login_analyst WHERE User_name='$User_name'";
			...
			{
				$query="insert into login_analyst values('$User_name','$pass_word')";
				$query_run= mysqli_query($con,$query);
				if($query_run)
				{
